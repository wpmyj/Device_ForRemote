...
@interface MHGatewayLightTimerView ()<UIActionSheetDelegate>

@end

@implementation MHGatewayLightTimerView {
    MHDevice*                   _device;
    NSArray*                    _timerList;
...
- (void)buildSubviews {
    ...
    [_tableview registerClass:[MHGatewayLightTimerViewCell class] forCellReuseIdentifier:TimerCellId];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MHGatewayLightTimerViewCell* cell = [tableView dequeueReusableCellWithIdentifier:TimerCellId];
    [cell configureWithDataObject:timer];
    
    __weak MHGatewayLightTimerView* weakSelf = self;
    cell.onSwitch = ^(void) {
