//
//  MHViewController+GWStatusCnt.m
//  MiHome
//
...
#import "MHLuViewController+GWStatusCnt.h"
#import <objc/runtime.h>

@implementation MHLuViewController (GWStatusCnt)

NSDate *            _startTime_MHLuViewController;
NSDate *            _endTime_MHLuViewController;
...
-(void)gw_viewWillAppear:(BOOL)animated{
    ...
    _startTime_MHLuViewController = [NSDate date];
}

-(void)gw_viewWillDisappear:(BOOL)animated{
    [self gw_viewWillDisappear:animated];
    
    _endTime_MHLuViewController = [NSDate date];
    [self gw_viewTimeCount];
}
...
-(void)gw_viewTimeCount{
    ...
    NSTimeInterval timerInterval = [_endTime_MHLuViewController timeIntervalSinceDate:_startTime_MHLuViewController];
